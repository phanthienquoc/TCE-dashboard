...
export const ENGINE_REGISTRY: EngineDefinition[] = [
  ...
  },
  {
    ...
    defaults: { realtimeQuotes: true, reconnectOnFailure: true, pollingSeconds: 15, orderQuantity: 0.01, positionSide: 'BOTH' },
  },
  {
    id: 'binance-xau',
    name: 'Binance XAU Futures',
    description: 'Consumes Telegram XAU signals and maintains TP/SL protection in realtime.',
    platform: 'Binance',
