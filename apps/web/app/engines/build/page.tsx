...
const BUILD_STEPS: BuildStep[] = [
  ...
  },
  {
    ...
    verification:
      'Persistence/runtime adapter implemented in ab15802; CI is red on pre-existing test/format failures, so DONE is blocked',
  },
  {
    id: 'cron',
    phase: '07',
    ...
    verification:
      'Phase runtime baseline is present on the unified branch; final CI verification pending',
  },
  {
    id: 'demo',
    phase: '08',
