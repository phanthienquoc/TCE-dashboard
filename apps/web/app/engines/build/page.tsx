...
const BUILD_STEPS: BuildStep[] = [
  {
    ...
    verification: 'PR #739 merged squash; CRDE core decision matrix added and reviewed'
  },
  {
    id: 'market-pool',
    phase: '02',
    ...
    verification: 'Deterministic candidate fixtures',
  },
  {
    id: 'decision',
    phase: '03',
  ...
  },
  {
    ...
    verification: 'Cron dry-run + Supabase run audit',
  },
  {
    id: 'demo',
    phase: '08',
