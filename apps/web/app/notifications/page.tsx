...
export default function NotificationsPage() {
  ...
  const select = (id: string) => { if (id === 'notifications') return; if (id === 'engine') return window.location.assign('/engines'); if (id === 'settings') return window.location.assign('/dashboard?tab=settings'); if (id === 'overview') return window.location.assign('/dashboard'); return window.location.assign(`/dashboard?tab=${id}`); };
