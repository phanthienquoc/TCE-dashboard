    ...
    return (
      <main className="app-shell">
        <div className="app-container app-content">
          <div className="loading-state p-4">Loading…</div>
        </div>
      </main>
    );
  return (
    <main className="app-shell">
      <div className="app-container app-content engine-page-content">
        <div className="mb-3 flex items-center gap-2">
          <Link
            href="/engines"
            className="grid size-11 shrink-0 place-items-center rounded-xl border border-border bg-surface text-foreground transition-transform duration-200 active:scale-95"
            aria-label="Back to engines"
          >
            <ArrowLeft className="size-4" />
          </Link>
          <div>
            <p className="eyebrow">Binance Futures</p>
            <p className="account-email">XAU Trading</p>
          </div>
        </div>
