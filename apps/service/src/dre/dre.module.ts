...
@Module({
  imports: [DbModule],
  controllers: [DreDashboardController],
  providers: [DividendCampaignRepository, DividendCampaignService, RollingPositionService, SettlementService, CapitalRecyclingRepository, CapitalRecyclingService],
  exports: [DividendCampaignRepository, DividendCampaignService, RollingPositionService, SettlementService, CapitalRecyclingService],
})
