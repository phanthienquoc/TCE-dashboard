...
import { CapitalSlotAllocator, type CapitalSlotAllocatorOutcome } from '../capital/capital-slot-allocator';
...
export type AllocatedOrderPlanOutcome =
  | Readonly<{ ok: true; plan: NonNullable<Extract<OrderPlannerOutcome, { ok: true }>['plan']>; allocation: CapitalSlotAllocatorOutcome & { ok: true } }>
